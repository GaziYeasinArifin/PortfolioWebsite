      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="font-display text-4xl font-medium tracking-tight md:text-5xl lg:text-6xl">
            Let's build <span className="italic bg-gradient-to-r from-pink-500 via-purple-500 via-blue-500 via-cyan-400 to-green-400 bg-clip-text text-transparent animate-[gradient_3s_ease-in-out_infinite] bg-[length:200%_auto]">meaningful</span> products together.
          </h2>
